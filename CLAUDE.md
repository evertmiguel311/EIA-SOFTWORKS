...
>
> ℹ️ **Nota (2026-09-04):** aparte de lo anterior, `desarrollo-software-a-medida/index.html` llegó a esta sesión con cambios ya hechos fuera de esta conversación (origen no confirmado) que no se tocaron pero sí se incluyeron en el mismo commit a pedido del dueño de la marca: los 3 niveles de "Niveles de plataforma" dejaron de mostrar precios fijos en COP (`$14.000.000`, `$45.000.000`, `$130.000.000` y sus costos de infraestructura/año) y ahora muestran el alcance como lista de bullets + un tiempo estimado, sin cifra; el enlace "Planes" se quitó del nav (desktop y móvil); y el CTA del hero pasó de "Ver rangos de precio" a "Ver niveles de proyecto". Esta conversación no confirmó la motivación del cambio con el dueño de la marca — si no fue intencional, revisar antes de asumir que reemplaza la política de precios visible que tenía antes esa página.
