(function () {
  ...
  window.__BRAND__ = {
    ...
    contact: {
      email: "evertmiguel311@gmail.com",
    ...
    solutions: [
      {
        ...
        desc: "Sistemas internos y productos digitales construidos alrededor de cómo opera realmente tu equipo.",
        img: "assets/img/soluciones-plataformas.webp",
        alt: "Rack de servidores en un centro de datos, referencia visual de infraestructura de plataformas"
      },
      {
        tag: "Automatización",
        title: "Automatización de procesos",
        desc: "Reducimos tareas manuales conectando sistemas y estandarizando flujos operativos.",
        img: "assets/img/soluciones-automatizacion.webp",
        alt: "Brazo robótico industrial en una línea de manufactura, referencia visual de automatización"
      },
      {
        tag: "Transformación",
        title: "Transformación digital integral",
        desc: "Acompañamos la migración de procesos analógicos hacia una operación digital ordenada.",
        img: "assets/img/soluciones-transformacion.webp",
        alt: "Equipo trabajando en laptops durante una sesión de trabajo digital"
      }
    ],
